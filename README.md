...
| 설명                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **UX & Interaction** | - [**[인터랙션]** 모달 ESC 키 제어 방식 최적화 (로컬 vs 전역 이벤트 비교 분석)](https://www.notion.so/ESC-vs-268bbeae3e2b80e5a292f152e60e3d5d) <br> - [**[유저 흐름]** 로그인 성공 후 이전 맥락 유지를 위한 스마트 리다이렉트 구현](https://www.notion.so/UX-268bbeae3e2b8012882bce823bdca54f) <br> - [**[시각적 안정성]** Preload 기법을 적용한 모달 Warning 이미지 로딩 속도 및 UX 개선](https://www.notion.so/UX-warning-preload-26bbbeae3e2b8017ada8e43ddc792d31) |
| **Performance** | - [**[로딩 최적화]** Code Splitting 및 Lazy Loading 도입으로 초기 번들 크기 감소](https://dust-radiator-52b.notion.site/Lazy-Loading-263b2ffc607580088b60c780d4d67af7?source=copy_link) <br> - [**[리소스 관리]** Tanstack Query 캐싱을 활용한 중복 API 요청 제거 및 네트워크 비용 절감](https://dust-radiator-52b.notion.site/Tanstack-Query-API-263b2ffc607580df8b40d836d1afb1fc?source=copy_link) <br> - [**[렌더링]** 커스텀 클래스 적용 시 CSS 우선순위(Typography) 문제 해결](https://www.notion.so/248bbeae3e2b80adb9b2c8a16d298ea0) |
| **Stability & Security** | - [**[에러 핸들링]** Next.js App Router 기반의 선언적 에러 페이지 및 코드별 UI 대응](https://www.notion.so/in-237bbeae3e2b80588e00f306680edaec) <br> - [**[보안]** Form-data 처리 과정에서의 취약점 분석 및 보안 강화](https://dust-radiator-52b.notion.site/form-data-263b2ffc607580fc9f92f3a23698cdd7?source=copy_link) <br> - [**[데이터 무결성]** 예약 시스템 내 중복 요청 방지 로직 설계](https://www.notion.so/269bbeae3e2b808588bad2c3d4045729) |
| **Architecture** | - [**[상태 관리]** Context API를 활용한 Props Hell 해결 및 컴포넌트 간 데이터 흐름 최적화](https://dust-radiator-52b.notion.site/Props-Hell-Context-API-263b2ffc607580b5923cd91b1bd088d4?source=copy_link) |
